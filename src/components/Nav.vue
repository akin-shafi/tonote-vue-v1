      ...
      <ul class="nav navbar-nav align-items-center ms-auto">
              ...
              <a class="d-flex" href="#">
                <div class="list-item d-flex align-items-start">
                  <div class="me-1">
                    <div class="avatar">
                      <img
                        src="<?php echo url_for('app-assets/images/portrait/small/avatar-s-15.jpg') ?>"
                        alt="avatar"
                        width="32"
                        height="32"
                      />
              ...
              ><a class="d-flex" href="#">
                <div class="list-item d-flex align-items-start">
                  <div class="me-1">
                    <div class="avatar">
                      <img
                        src="<?php echo url_for('app-assets/images/portrait/small/avatar-s-3.jpg') ?>"
                        alt="avatar"
                        width="32"
                        height="32"
                      />
        ...
        <li class="nav-item dropdown dropdown-user">
          ...
          >
            ...
            <span class="avatar">
              <!-- <img class="round img" src="<?php echo url_for('app-assets/images/portrait/small/avatar-s-11.jpg') ?>" alt="JD" height="40" width="40"> -->
